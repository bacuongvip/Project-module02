...
function Screen({setUpdate}) {
    const [product, setProduct] = useState([]);
    const loadProduct = async () => {
        const result = await axios.get(`http://localhost:8000/products`);
        const array = result.data.filter((e) => e.category === 'screen')
        setProduct(array);
    }
    useEffect(() => {
        loadProduct();
        ...
        <div className='page-wrapper'>
                ...
                <div className='container'>
                    <div className="breadcrumb">
                        ...
                        <li>
                            <a href="https://www.tncstore.vn/apple.html">Màn Hình PC</a>
                        </li>
                        </ul>
                    </div>
                    <div id="content" className="category__content">
                        ...
                        <div className="category__product-list">
                            <div className="list-header">
                                ...
                                <div class="category-name">Màn hình PC</div>
                            ...
                            <div className="product-list">
                                ...
                                <div key={i} className="swiper-slide swiper-slide-duplicate" data-swiper-slide-index={6} role="group" aria-label="1 / 18" style={{ flexGrow: "1" }}>
                                    <div className="product__thumb">
                                        <Link to={`/screen/${e.id}`} className="product__link">
                                            <img
                                            src={e.img}
                    ...
                    <div className="category__description">
                        <div className="title">Màn hình PC</div> 
