...
function Apple({setUpdate}) {
    const [product, setProduct] = useState([]);

    const loadProduct = async () => {
        const result = await axios.get(`http://localhost:8000/products`);
        const array = result.data.filter((e) => e.category === 'apple')
        setProduct(array);
    }
    useEffect(() => {
        loadProduct();
        ...
        <div className='page-wrapper'>
                ...
                <div className='container'>
                    <div className="breadcrumb">
                        ...
                        <li>
                            <a href="https://www.tncstore.vn/apple.html">Apple</a>
                        </li>
                        </ul>
                    </div>
                            ...
                            <div className="product-list">
                                ...
                                <div key={i} className="swiper-slide swiper-slide-duplicate" data-swiper-slide-index={6} role="group" aria-label="1 / 18" style={{ flexGrow: "1" }}>
                                    <div className="product__thumb">
                                        <Link to={`/apple/${e.id}`} className="product__link">
                                            <img
                                            src={e.img}
